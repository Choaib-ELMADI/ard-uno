...
const Cookie = () => {
  return (
    <div className='our-privacy'>
        <h2 style={{textAlign: 'center'}}><b>COOKIE POLICY</b></h2>
        <p>Effective date: 2023-02-04</p>
        <p className='rule'>
          1. <b>Introduction</b></p>
        <p>Welcome to <b> Ard-Uno</b>.</p>
        <p><b>Ard-Uno</b> (“us”, “we”, or “our”) operates <b>ard-uno.netlify.app</b> (hereinafter referred to as <b>“Service”</b>).</p>
        <p>Our Privacy Policy governs your visit to <b>ard-uno.netlify.app</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
        ...
        <p className='rule'>
          2. <b>Definitions</b></p>
        <p><b>SERVICE</b> means the ard-uno.netlify.app website operated by Ard-Uno.</p>
        ...
        <p className='rule'>
          3. <b>Information Collection and Use</b></p>
        <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>
        <p className='rule'>
          4. <b>Types of Data Collected</b></p>
        ...
        <p className='rule'>
          5. <b>Use of Data</b></p>
        <p>Ard-Uno uses the collected data for various purposes:</p>
        ...
        <p className='rule'>
          7. <b>Transfer of Data</b></p>
        <p>Your information, including Personal Data, may be transferred to - and maintained on - computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.</p>
        <p>If you are located outside Maroc and choose to provide information to us, please note that we transfer the data, including Personal Data, to Maroc and process it there.</p>
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
        <p>Ard-Uno will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
        <p className='rule'>
          8. <b>Disclosure of Data</b></p>
        ...
        <p className='rule'>
          9. <b>Security of Data</b></p>
        <p>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
        <p className='rule'>
          10. <b>Your Data Protection Rights Under General Data Protection Regulation (GDPR)
        </b></p>
        <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>
        <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
        <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>choaib3elmadi@gmail.com</b>.</p>
        ...
        <p className='rule'>
          11. <b>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</b></p>
        ...
        <p>0.4. users are able to change their personal information by emailing us at <b>choaib3elmadi@gmail.com</b>.</p>
        <p>Our Policy on “Do Not Track” Signals:</p>
        <p>We honor Do Not Track signals and do not track, plant cookies, or use advertising when a Do Not Track browser mechanism is in place. Do Not Track is a preference you can set in your web browser to inform websites that you do not want to be tracked.</p>
        <p>You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser.</p>
        <p className='rule'>
          12. <b>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</b></p>
        ...
        <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>choaib3elmadi@gmail.com</b>.</p>
        <p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</p>
        <p className='rule'>
          13. <b>Service Providers</b></p>
        ...
        <p className='rule'>
          19. <b><b>Children's Privacy</b></b></p>
        ...
        <p className='rule'>
          20. <b>Changes to This Privacy Policy</b></p>
        ...
        <div className='secondary-footer'>
          <p>
            ...
            <b> choaib3elmadi@gmail.com</b>.
          </p>
          <p>
            This <a href="https://policymaker.io/privacy-policy/">Privacy Policy </a> 
            was created for <b>ard-uno.netlify.app</b> by <a href="https://policymaker.io">PolicyMaker.io </a> 
            on 2023-02-04.
          </p>
        </div>
    </div>
